...
class UserManagementServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateUser = channel.unary_unary(
                '/usermanagement.UserManagementService/UpdateUser',
                request_serializer=user__management__pb2.UpdateUserRequest.SerializeToString,
                response_deserializer=user__management__pb2.UpdateUserResponse.FromString,
                _registered_method=True)
        self.DeleteUser = channel.unary_unary(
                '/usermanagement.UserManagementService/DeleteUser',
                request_serializer=user__management__pb2.DeleteUserRequest.SerializeToString,
                response_deserializer=user__management__pb2.DeleteUserResponse.FromString,
                _registered_method=True)
...
def add_UserManagementServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__management__pb2.UpdateUserResponse.SerializeToString,
            ),
            'DeleteUser': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteUser,
                    request_deserializer=user__management__pb2.DeleteUserRequest.FromString,
                    response_serializer=user__management__pb2.DeleteUserResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'usermanagement.UserManagementService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('usermanagement.UserManagementService', rpc_method_handlers)
...
class UserManagementService(object):
    ...
    def UpdateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            user__management__pb2.UpdateUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def DeleteUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            user__management__pb2.DeleteUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
